...
//    // Event Services:
//    // create a new sensor at Main process
//    ActorManager.getSensorManager().tell(new SensorManager.Add("crawler", CrawlerSensor.create()));
//
//    // create a scheduled job
//    ActorManager.getSensorManager().tell(new SensorManager.Send("crawler", ));
//    // Seconds:
//    // send sensor message within the process
//    for (int i = 0; i < 11; i++) {
//      ActorManager.getSensorManager().tell(new SensorManager.Send("crawler", ));
...
//    // Finally:
//    // At the end of the process, send message to stop process
//    ActorManager.getSensorManager().tell(new SensorManager.Stop("crawler"));
//    system.terminate();
